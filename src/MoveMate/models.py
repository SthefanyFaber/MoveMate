...
class Amigo(models.Model):
    usuario = models.ForeignKey(User, on_delete=models.CASCADE, related_name='meus_amigos')
    amigo = models.ForeignKey(User, on_delete=models.CASCADE, related_name='sou_amigo_de')

    def __str__(self):
        return f"{self.usuario.username} adicionou {self.amigo.username}"
...
class Comentario(models.Model):
    ...
    def __str__(self):
        return f"Comentário de {self.usuario.username} em {self.post}"
...
class Curtida(models.Model):
    ...
    def __str__(self):
        return f"Curtida de {self.usuario.username} em {self.post}"
